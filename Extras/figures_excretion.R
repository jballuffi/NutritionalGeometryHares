...
ggsave("Output/figures/fecalprotein.jpg", Proteinweight, width = 5, height = 5, units = "in")
ggsave("Output/figures/fecalprotein_intake.jpg", Proteinintake, width = 5, height = 5, units = "in")
