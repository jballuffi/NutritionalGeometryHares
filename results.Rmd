...
Based on fecal composition and quantity, diet DMD differed across diets with Diet D being the most digestible and Diet A being the least (p \< 0.001; Figure 4A). Diet A had significantly lower DMD than all other diets (p \< 0.001), and Diet B was also significantly less digestible than diet D (p \< 0.01; Figure 4A). Daily CP (p = `r CPdigpval`) and NDF (p = `r NDFdigpval`) digestion rates also differed between diets. CP digestibility increased significantly as diet CP increased from A to D (p \< 0.001; Figure 4B). Diet D had \_\_\_\_ times greater protein digestibility than Diet A. Diet A had the highest NDF digestibility, \_\_\_\_ times greater than Diet C (P \< 0.01) and \_\_\_\_ times greater than Diet D (P \< 0.05; Figure 4C). Diet B had \_\_\_\_ times the NDF digestibility of Diet C (p \< 0.01, Figure 4C).
